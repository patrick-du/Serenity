...
export default class SignUpScreen extends Component {
  ...
  signup = () => {
    fetch('https://patrickdu-serenity-server.herokuapp.com/users/register', {
      method: 'POST',
      headers: {
        ...
        <View style={{ marginVertical: 30 }}>
          ...
          <TouchableOpacity>
            <Text style={styles.subTextCenter}>
              Already have an account? <Text style={{ color: '#7268C9' }} onPress={this.onPressLogin}>Login</Text>
            </Text>
          </TouchableOpacity>
        </View>
